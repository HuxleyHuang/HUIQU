...
-(void)creatSubViews{
    ...
    textF = [[UITextField alloc]initWithFrame:CGRectMake(30, 80, Main_Screen_Width-60, 50)];
    ...
    textF2 = [[UITextField alloc]initWithFrame:CGRectMake(30, 140, Main_Screen_Width-60, 50)];
...
-(void)nextBtnAction{
    ...
    if (nextBtn.backgroundColor != [UIColor lightGrayColor]) {
        ...
        if([result isEqualToString:@"0"]){
            ...
            updatePwdVC.phone = textF.text;
            updatePwdVC.token = result;
