...
#define pageSize (myHeight * 0.2 > 30 ? 30 : myHeight * 0.2)
...
@implementation DCPicScrollView{
    ...
    //__weak UIControl *_leftControl,*_centerControl,*_rightControl;
...
- (UIView *)creatLabelBgView {
   ...
   UIToolbar *v = [[UIToolbar alloc] initWithFrame:CGRectMake(0, myHeight-pageSize, myWidth, pageSize)];
    ...
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, myWidth,pageSize)];
