...
#import "HHScrollLabel.h"

@interface HHScrollLabel()
{
    BOOL seted;
...
- (void)setSpeed:(HHLabelSpeed)speed
{
    _speed = speed;
    switch (_speed) {
        case HHLabelSpeedFast:
            rate = 90.;
            break;
        case HHLabelSpeedMild:
            rate = 75;
            break;
        case HHLabelSpeedSlow:
            rate = 40.;
            break;
        default:
            break;
