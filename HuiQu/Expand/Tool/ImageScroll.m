...
{
    ImageScroll *selfImageScroll=[[ImageScroll alloc]initWithFrame:rect];
...
{
    [[ImageScroll alloc] clearNetImageChace];
}
...
-(void)ShowImageScrollWithImageArray:(NSArray *)array andBtnClick:(BtnClickBlock)btnClick andShowImageStyle:(ImageShowStyle)showStyle
{
    ...
    myScroll.contentSize=CGSizeMake(self.bounds.size.width*(array.count+2), self.bounds.size.height);
