...
//设置view的背景色
#define SetViewBackgroundColor(view) view.backgroundColor=[UIColor redColor]
...
//实际视图宽高
#define Fact_Screen_Height  [[UIScreen mainScreen] bounds].size.height-20-44-49
#define Fact_Screen_Width   [[UIScreen mainScreen] bounds].size.width
//导航栏高度
