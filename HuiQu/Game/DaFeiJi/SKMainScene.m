...
- (void)initBackground{
    ...
    _background1.size = CGSizeMake(Main_Screen_Width, Main_Screen_Height);
    ...
    _background2.size = CGSizeMake(Main_Screen_Width, Main_Screen_Height);
...
- (void)scrollBackground{
    ...
    {
        _adjustmentBackgroundPosition = Main_Screen_Height;
    }
    
    [_background1 setPosition:CGPointMake(self.size.width / 2, _adjustmentBackgroundPosition - Main_Screen_Height)];
